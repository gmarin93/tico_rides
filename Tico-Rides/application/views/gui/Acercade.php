        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-caption">
                    ...
                    <br></br>
                    <br></br>
                    <div class="parrafo"> <strong> <p>  Es un proyecto asignado en el curso de Diseño Web donde permite conseguir un ride de alguna persona
                  ...
                  Desarrollado el 21 de Agosto del 2016.</p></strong> </div>
                </div>
            </div>
        </div>
        <!-- Con
...
<!-- Add Google Maps -->
        ...
        <footer class="text-center">
            <a class="up-arrow" href="#myPage" data-toggle="tooltip" title="TO TOP"> <span class="glyphicon glyphicon-chevron-up"></span> </a>
            <br>
            <br> </footer>
        <script>
