        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo site_url('Ride/perf') ?>">Volver</a></li>
    ...
    ?>
              ...
              ?>
                            ...
                            <div class="acerca">
                                ...
                                <br></br>
                                <textarea placeholder="Auto Toyota Terius Color Gris" id="infoD"   name="rdir" rows="4" cols="25" required><?php echo isset($info)?$info['descripcion']:''; ?></textarea>
                                <br>
                                <br/> </div>
